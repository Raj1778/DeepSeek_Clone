  ...
  return (
    ...
    >
      <div>
        <div
          className={`flex ${
            expand ? "flex-row gap-6" : "flex-col items-center gap-4"
          }`}
        >
          <Image
          ...
          >
            ...
            >
              {expand ? "Collapse Sidebar" : "Expand Sidebar"}
              {/* <div
      ...
      <div>
        <div
          className={`flex items-center cursor-pointer group relative ${
            expand
              ...
              : "h-10 w-10 max-auto hover:bg-gray-500/30 rounded-lg"
          }`}
        >
          <Image
        ...
        >
          {user ? (
            ...
            <Image src={assets.profile_icon} className="w-7" alt=""></Image>
          )}
